  ...
  return (
    ...
    >
      <Paper className={classes.paperheader}>
        <Typography gutterBottom variant="h1" style={{ padding: 20 }}>
          Trouvez un prestataire de qualité et disponible.
        </Typography>
        <Typography gutterBottom variant="h2">
          Des milliers d utilisateurs utilisent dmprest.com pour trouver les meilleurs prestataires
        </Typography>
        <Typography gutterBottom variant="h3" style={{ padding: 20 }}>
